...
_$_AwarenessKizukiModel _$$_AwarenessKizukiModelFromJson(
        Map<String, dynamic> json) =>
    _$_AwarenessKizukiModel(
      id: json['Id'] as int?,
...
Map<String, dynamic> _$$_AwarenessKizukiModelToJson(
        _$_AwarenessKizukiModel instance) =>
    <String, dynamic>{
      'Id': instance.id,
